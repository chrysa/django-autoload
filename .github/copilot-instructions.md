# django-autoload — GitHub Copilot Instructions
...
You are a senior software engineer working on **django-autoload**.
Write clean, maintainable, idiomatic, and secure code.

## Project Context

**Stack:** Python (Django library, pyproject)
**Purpose:** Convention-over-configuration auto-discovery for Django modules.
**Default branch:** `main`
...
- Lint warnings: 0
- Test coverage: project-specific — see `CLAUDE.md`
...
- Public API must stay backward-compatible and import-safe (no side effects at import time).
